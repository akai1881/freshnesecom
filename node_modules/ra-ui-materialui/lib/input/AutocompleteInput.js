...
var AutocompleteInput = function (props) {
    ...
    var handleClickClearButton = react_1.useCallback(function (openMenu) { return function (event) {
        ...
        if (!resettable) {
            ...
            if (clearAlwaysVisible) {
                ...
                return (react_1.default.createElement(core_1.InputAdornment, { position: "end" },
                    react_1.default.createElement(core_1.IconButton, { className: classes.clearButton, "aria-label": label_1, title: label_1, disableRipple: true, disabled: true },
                        react_1.default.createElement(Clear_1.default, { className: classnames_1.default(classes.clearIcon, classes.visibleClearIcon) }))));
            }
            else {
                if (endAdornment) {
                    return endAdornment;
            ...
            return (react_1.default.createElement(core_1.InputAdornment, { position: "end" },
                react_1.default.createElement(core_1.IconButton, { className: classes.clearButton, "aria-label": label_2, title: label_2, disableRipple: true, onClick: handleClickClearButton(openMenu), onMouseDown: handleMouseDownClearButton, disabled: disabled },
                    react_1.default.createElement(Clear_1.default, { className: classnames_1.default(classes.clearIcon, (_a = {},
    ...
    return (react_1.default.createElement(downshift_1.default, __assign({ inputValue: filterValue, onChange: handleChange, selectedItem: selectedItem, itemToString: function (item) { return getChoiceValue(item); } }, rest), function (_a) {
        ...
        return (react_1.default.createElement("div", { className: classes.container },
            react_1.default.createElement(core_1.TextField, __assign({ id: id, name: input.name, InputProps: __assign({ inputRef: storeInputRef, endAdornment: getEndAdornment(openMenu), onBlur: onBlur, onChange: function (event) {
                        handleFilterChange(event);
                        setFilterValue(event.target.value);
                        onChange(event);
                    }, onFocus: onFocus }, InputPropsWithoutEndAdornment), error: !!(touched && error), label: react_1.default.createElement(ra_core_1.FieldTitle, __assign({ label: label }, labelProps, { source: source, resource: resource, isRequired: typeof isRequiredOverride !==
                        'undefined'
                        ? isRequiredOverride
