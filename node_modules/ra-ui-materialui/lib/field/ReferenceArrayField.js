...
exports.ReferenceArrayFieldView = function (props) {
    ...
    var loaded = ra_core_1.useListContext(props).loaded;
    if (!loaded) {
        return React.createElement(layout_1.LinearProgress, { className: classes.progress });
    }
    return (React.createElement(React.Fragment, null,
        react_1.cloneElement(react_1.Children.only(children), __assign(__assign({}, sanitizeFieldRestProps_1.default(rest)), { className: className,
            resource: resource })),
        ' ',
        pagination &&
            props.total !== undefined &&
            react_1.cloneElement(pagination, sanitizeFieldRestProps_1.default(rest))));
};
