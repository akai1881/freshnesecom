...
var ReferenceField = function (_a) {
    ...
    return get_1.default(record, source) == null ? (emptyText ? (React.createElement(core_1.Typography, { component: "span", variant: "body2" }, emptyText)) : null) : (React.createElement(exports.NonEmptyReferenceField, __assign({}, props, { record: record, source: source })));
};
 ...
 */
exports.NonEmptyReferenceField = function (_a) {
    ...
    return (React.createElement(ra_core_1.ResourceContextProvider, { value: reference },
        React.createElement(PureReferenceFieldView, __assign({}, props, ra_core_1.useReference({
            reference: reference,
...
exports.ReferenceFieldView = function (props) {
    ...
    if (resourceLinkPath) {
        return (React.createElement(Link_1.default, { to: resourceLinkPath, className: className, onClick: stopPropagation }, react_1.cloneElement(react_1.Children.only(children), __assign({ className: classnames_1.default(children.props.className, classes.link // force color override for Typography components
            ...
            translateChoice: translateChoice }, sanitizeFieldRestProps_1.default(rest)))));
    }
